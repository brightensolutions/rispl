                ...
                <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="relative">
                    <div className="relative aspect-square overflow-hidden">
                      ...
                      {/* Social Icons */}
                      <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                    ...
                    <div className="absolute top-4 right-4 w-12 h-12">
                      <div className="absolute inset-0 border-t-2 border-r-2 border-[#EDC967] rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100" />
                    </div>
                    <div className="absolute top-4 left-4 w-12 h-12">
                      <div className="absolute inset-0 border-t-2 border-l-2 border-[#EDC967] rounded-tl-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 delay-200" />
                    </div>
                  </div>
                  ...
                  <div className="p-8 md:p-12 lg:p-16 w-full md:max-w-2xl">
                    <div className="space-y-6">
                      ...
                      <div className="relative">
                        ...
                        {/* Subtle Underline */}
                        <div className="w-32 h-0.5 bg-[#EDC967] mt-4" />
                      </div>
